...
# PHP Installation
RUN apt-get -y install php7.0 php7.0-fpm php7.0-xml php7.0-gd php7.0-json php7.0-mbstring php7.0-soap php7.0-zip php7.0-opcache php7.0-mcrypt php7.0-curl php7.0-pgsql php7.0-mysql php-xdebug php-redis
